	...
	class Laporan_nilai extends CI_Controller
	{
		...
		function nilai_semester(){
	       ...
	       $siswa = $this->db->query($sqlSiswa)->row_array();
			...
			//             WHERE tj.kd_mapel=tm.kd_mapel and tj.kd_tingkatan=7 and";
	        ...
	        foreach ($mapel as $m){
				...
				$pdf->Cell(12,5,  $m['nilai'],1,0,'L');
	            $pdf->Cell(30,5,  Terbilang($m['nilai']),1,0,'L');
	            $pdf->Cell(23,5, $m['nilai'] >=75 ? 'Lulus' : 'Tidak Lulus',1,0,'L');
